...
export function registerCodeActions(
  ...
  context.subscriptions.push(
    vscode.commands.registerCommand("hybrid-ai-runtime.kilo-code.explainCode", async () => {
    ...
    vscode.commands.registerCommand("hybrid-ai-runtime.kilo-code.fixCode", async () => {
      const ctx = getEditorContext()
      if (!ctx) return
    ...
    vscode.commands.registerCommand("hybrid-ai-runtime.kilo-code.improveCode", async () => {
      const ctx = getEditorContext()
      if (!ctx) return
    ...
    vscode.commands.registerCommand("hybrid-ai-runtime.kilo-code.addToContext", async () => {
      const ctx = getEditorContext()
      if (!ctx) return
    ...
    vscode.commands.registerCommand("hybrid-ai-runtime.kilo-code.focusChatInput", async () => {
      const view = target()
      if (!(await revealTarget(view))) return
    ...
    vscode.commands.registerCommand("hybrid-ai-runtime.kilo-code.toggleChatSearch", async () => {
      const view = target()
      if (!(await revealTarget(view))) return
