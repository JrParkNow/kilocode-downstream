...
const CONFIG = "hybrid-ai-runtime.kilo-code.autoApprove"
const KEY = "enabled"
...
export function registerToggleAutoApprove(
  ...
  context.subscriptions.push(vscode.commands.registerCommand("hybrid-ai-runtime.kilo-code.toggleAutoApprove", toggle))
