...
const KEY = "hybrid-ai-runtime.kilo-code.agentManager.terminalButtonDestination"
...
export function readTerminalDestination(): TerminalDestination {
  const config = vscode.workspace.getConfiguration("hybrid-ai-runtime.kilo-code.agentManager")
